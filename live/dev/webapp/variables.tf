...
variable "ec2_badge_text" {
  ...
  type        = string
  default     = "AWS Terraform Foundation - Dev"
}

variable "ec2_headline" {
  description = "Headline shown on the EC2 landing page"
  type        = string
  default     = "Development web application infrastructure"
}

variable "ec2_description" {
  description = "Short description shown on the EC2 landing page"
  type        = string
  default     = "This dev EC2 web server was provisioned from reusable Terraform modules."
}
